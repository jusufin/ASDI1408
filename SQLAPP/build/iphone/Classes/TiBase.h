...
// in simulator we redefine to format for SQLAPP Developer console
...
{\
	NSString * exceptionName = [@"org.sqlapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sqlapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISQLAPPNativeItemNone = -1, 
	UISQLAPPNativeItemSpinner = -2,
	UISQLAPPNativeItemProgressBar = -3,
	
	UISQLAPPNativeItemSlider = -4,
	UISQLAPPNativeItemSwitch = -5,
	UISQLAPPNativeItemMultiButton = -6,
	UISQLAPPNativeItemSegmented = -7,
	
	UISQLAPPNativeItemTextView = -8,
	UISQLAPPNativeItemTextField = -9,
	UISQLAPPNativeItemSearchBar = -10,
	
	UISQLAPPNativeItemPicker = -11,
	UISQLAPPNativeItemDatePicker = -12,
	
	UISQLAPPNativeItemInfoLight = -13,
	UISQLAPPNativeItemInfoDark = -14,
	
	UISQLAPPNativeItemDisclosure = -15,
	
	UISQLAPPNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SQLAPP instances of
