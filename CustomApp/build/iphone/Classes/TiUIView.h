...
/**
 Base class for all CustomApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CustomApp view hierarchy (such as wrapped iOS UIViews) was touched.
