...
// in simulator we redefine to format for CustomApp Developer console
...
{\
	NSString * exceptionName = [@"org.customapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.customapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICustomAppNativeItemNone = -1, 
	UICustomAppNativeItemSpinner = -2,
	UICustomAppNativeItemProgressBar = -3,
	
	UICustomAppNativeItemSlider = -4,
	UICustomAppNativeItemSwitch = -5,
	UICustomAppNativeItemMultiButton = -6,
	UICustomAppNativeItemSegmented = -7,
	
	UICustomAppNativeItemTextView = -8,
	UICustomAppNativeItemTextField = -9,
	UICustomAppNativeItemSearchBar = -10,
	
	UICustomAppNativeItemPicker = -11,
	UICustomAppNativeItemDatePicker = -12,
	
	UICustomAppNativeItemInfoLight = -13,
	UICustomAppNativeItemInfoDark = -14,
	
	UICustomAppNativeItemDisclosure = -15,
	
	UICustomAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CustomApp instances of
