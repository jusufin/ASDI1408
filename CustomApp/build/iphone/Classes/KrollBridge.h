...
@interface CustomAppObject : KrollCoverageObject {
#else
@interface CustomAppObject : KrollObject {
#endif
@private
...
extern NSString * CustomApp$ModuleRequireFormat;
