...
//@interface CustomAppObject : NSObject
//@end

@interface CustomAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CustomAppObject class]])
		{
			for (NSString *key in [[(CustomAppObject*)o modules] allKeys])
			{
