...
@interface ObjProjectObject : KrollCoverageObject {
#else
@interface ObjProjectObject : KrollObject {
#endif
@private
...
extern NSString * ObjProject$ModuleRequireFormat;
