...
// in simulator we redefine to format for ObjProject Developer console
...
{\
	NSString * exceptionName = [@"org.objproject." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.objproject";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIObjProjectNativeItemNone = -1, 
	UIObjProjectNativeItemSpinner = -2,
	UIObjProjectNativeItemProgressBar = -3,
	
	UIObjProjectNativeItemSlider = -4,
	UIObjProjectNativeItemSwitch = -5,
	UIObjProjectNativeItemMultiButton = -6,
	UIObjProjectNativeItemSegmented = -7,
	
	UIObjProjectNativeItemTextView = -8,
	UIObjProjectNativeItemTextField = -9,
	UIObjProjectNativeItemSearchBar = -10,
	
	UIObjProjectNativeItemPicker = -11,
	UIObjProjectNativeItemDatePicker = -12,
	
	UIObjProjectNativeItemInfoLight = -13,
	UIObjProjectNativeItemInfoDark = -14,
	
	UIObjProjectNativeItemDisclosure = -15,
	
	UIObjProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ObjProject instances of
