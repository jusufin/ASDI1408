...
/**
 Base class for all ObjProject views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ObjProject view hierarchy (such as wrapped iOS UIViews) was touched.
