...
//@interface ObjProjectObject : NSObject
//@end

@interface ObjProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ObjProjectObject class]])
		{
			for (NSString *key in [[(ObjProjectObject*)o modules] allKeys])
			{
